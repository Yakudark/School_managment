...
class Pager
{
    ...
    public function __construct($limit = 10, $extras = 1)
    {
        ...
        // résoud le problème de la page courante inexistante au lien étudiant
...
?>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <li class="page-item"><a class="page-link" href="<?= $this->links['first'] ?>">Début</a></li>

                <?php for ($x = $this->start; $x <= $this->end; $x++) : ?>
                    <li class="page-item <?= ($x == $this->page_number) ? ' active ' : ''; ?>"><a class="page-link" href="<?= preg_replace('/page=[0-9]+/', "page=" . $x, $this->links['current_link']) ?>"><?= $x ?></a></li>
                <?php endfor; ?>
                <li class="page-item"><a class="page-link" href="<?= $this->links['next'] ?>">Suivant</a></li>
            </ul>
        </nav>
<?php
