<nav class="navbar navbar-light ">
    ...
    <h3 class="text-center">Enseignant.e</h3>

    <div>
        <a class="link-offset-2 link-underline link-underline-opacity-0" href="<?= ROOT ?>/single_class/lectureradd/<?= $row->class_id ?>?&select=true">
            <button class="btn btn-sm btn-primary"><i class="icon-fa fa fa-plus"></i>Ajouter</button>
        </a>

        <a class="link-offset-2 link-underline link-underline-opacity-0" href="<?= ROOT ?>/single_class/lecturerremove/<?= $row->class_id ?>?&select=true">
