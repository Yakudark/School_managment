    ...
    <div class="d-flex flex-column align-items-center">
        ...
        <?php if ($row) : ?>
            <form method="post">
                ...
                <input autofocus class="form-control" value="<?= get_var('class', $row[0]->class) ?>" type="text" name="class" placeholder="Nom du discipline"><br><br>
